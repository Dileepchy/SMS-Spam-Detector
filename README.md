...
*A screenshot or GIF of your application is highly recommended here. It's the best way to show what your project does.*



*To create a GIF like this, you can use tools like [LICEcap](https://www.cockos.com/licecap/) or [ScreenToGif](https://www.screentogif.com/).*
...
*   This project was inspired by the tutorial from **CampusX**. A big thanks to them for their excellent educational content.
